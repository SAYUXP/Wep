...
let nombre=prompt("¡Nuevo récord! Ingresa tu nombre:");
...
await addDoc(collection(db,"ranking"),nuevo);
...
await deleteDoc(doc(db,"ranking",ranking[i].id));
